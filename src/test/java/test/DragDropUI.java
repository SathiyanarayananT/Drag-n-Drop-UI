...
public class DragDropUI {
	public void DragDropTest() throws InterruptedException {
		...
		driver.findElement(By.xpath("//label[text()='Enter a new name for this page:']/following-sibling::input[@name='name']")).sendKeys("test");
		
		//Click create
		driver.findElement(By.xpath("//div[@id='create-dialog']/following-sibling::div/button[text()='Create']")).click();
		...
		//This xpath also works,but to be very precise about the block, below xpath is used.
		
		WebElement startpointer = driver.findElement(By.xpath("//div[@id= 'module-1' and .//div[text()='Start']]/div[@class='mod-rail mod-south']/div"));
		WebElement sendsmsblockpointer = driver.findElement(By.xpath("//div[@id= 'module-2' and .//div[text()='Send an SMS']]/div[@class='mod-rail mod-north']/div"));
		...
		// enter values in Send an SMS block
		driver.findElement(By.xpath("//div[contains(text(),'SMTP Host:')]/following::input[@type='text']")).sendKeys("smtp.gmail.com");
		driver.findElement(By.xpath("//div[contains(text(),'Port')]/following::input[@type='text']")).sendKeys("456");
		driver.findElement(By.xpath("//div[contains(text(),'Username')]/following::input[@type='text']")).sendKeys("username");
		...
		driver.findElement(By.xpath("//div[@id= 'module-3']//textarea[@name='message_phrase[]']")).sendKeys("abc@gmail.com");
		
		// Join Send an SMS and Send an Email
		WebElement sendsmsblockpointer1 = driver.findElement(By.xpath("//div[@id= 'module-2' and .//div[text()='Send an SMS']]//div[@class='panel-nodes-attached inner']/div[2]"));
		WebElement sendanemailpointer1 = driver.findElement(By.xpath("//div[@id= 'module-3' and .//div[text()='Send an Email']]/div[@class='mod-rail mod-north']/div"));
		...
		WebElement sendsmsblockpointer2 = driver.findElement(By.xpath("//div[@id= 'module-2' and .//div[text()='Send an SMS']]//div[@class='panel-nodes-attached inner']/div[1]"));
		WebElement endblockpointer1 = driver.findElement(By.xpath("//div[@id= 'module-4' and .//div[text()='Exit App']]/div[@class='mod-rail mod-north']/div"));
		...
		WebElement sendemailblockpointer2 = driver.findElement(By.xpath("//div[@id= 'module-3' and .//div[text()='Send an Email']]//div[@class='panel-nodes-attached inner']/div[1]"));
		WebElement endblockpointer2 = driver.findElement(By.xpath("//div[@id= 'module-5' and .//div[text()='Exit App']]/div[@class='mod-rail mod-north']/div"));
		...
		WebElement sendemailblockpointer3 = driver.findElement(By.xpath("//div[@id= 'module-3' and .//div[text()='Send an Email']]//div[@class='panel-nodes-attached inner']/div[2]"));
		WebElement endblockpointer3 = driver.findElement(By.xpath("//div[@id= 'module-6' and .//div[text()='Exit App']]/div[@class='mod-rail mod-north']/div"));
